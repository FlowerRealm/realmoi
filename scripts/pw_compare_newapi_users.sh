...
realmoi_template="${repo_root}/scripts/pw_compare_newapi/templates/users_realmoi.pw.js.tmpl"
newapi_template="${repo_root}/scripts/pw_compare_newapi/templates/users_newapi.pw.js.tmpl"
...
pwc_require_file "${repo_root}/scripts/pw_compare_newapi/pairs/users.json" 'diff pairs'
python3 -X utf8 "${repo_root}/scripts/pw_compare_newapi/diff_images.py"   --out-dir "${out_dir}"   --pairs "${repo_root}/scripts/pw_compare_newapi/pairs/users.json"
